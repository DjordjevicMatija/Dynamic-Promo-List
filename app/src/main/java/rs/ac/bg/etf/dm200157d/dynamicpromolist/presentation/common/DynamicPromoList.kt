...
class DynamicPromoList @JvmOverloads constructor(
    ...
    private val adapter: DynamicPromoListAdapter
    ...
    init {
        context.theme.obtainStyledAttributes(
            ...
            try {
                val layoutOrientationInt = getInt(R.styleable.DynamicPromoList_itemLayoutOrientation, 1)
                itemLayoutOrientation = ItemLayoutOrientation.entries.toTypedArray()[layoutOrientationInt]
        ...
        adapter = DynamicPromoListAdapter(itemLayoutOrientation, titlePosition)
